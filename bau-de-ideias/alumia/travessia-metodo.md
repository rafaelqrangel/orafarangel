# Travessia — o quadro imersivo do AlumiaCast

> Método criado por Rafael em 29/07/2026. O nome do quadro é o próprio método: cada letra de TRAVESSIA é uma etapa do percurso que o ouvinte atravessa.
...
- **Travessia pocket (10 min, divisão 2-5-3):** para os minutos antes de uma reunião, uma conversa difícil ou uma decisão. Formato em [`formato-travessia-pocket.md`](formato-travessia-pocket.md).

## As nove etapas

| Letra | Etapa | O que acontece |
|---|---|---|
| **T** | Tempo para si | Dedicar tempo é a condição de qualquer evolução. Nada se desenvolve sem tempo reservado. |
| **R** | Reconhecer-se no processo | O processo não existiria sem quem o percorre. O ouvinte é o caminho e o caminhante, e o caminho se faz caminhando. |
| **A** | Atenção | Focar em uma parte do processo por vez, sem tentar abarcar o todo. |
| **V** | Vivenciar | A escolha de se jogar na experiência. É a permissão que abre o que vem depois, e sem ela nada acontece. |
| **E** | Experiência | Sair da teoria e sentir na pele. |
| **S** | Sentido | Encontrar o sentido daquilo, entender, se conectar, se enxergar dentro da experiência. |
| **S** | Simbolizar | Criar um símbolo que represente e cristalize o vivido. É a peça nova do mosaico da vida. |
| **I** | Integrar | O símbolo não fica apartado, ele entra. Simbiose: uma parte de si que guarda o DNA da experiência, como uma tatuagem que conta uma história. |
| **A** | Autoria | Depois do percurso, a pessoa se torna autora da própria história e da própria travessia. |
...
**Pocket (10 min, divisão 2-5-3):** T e R na desaceleração de dois minutos. A, V e E nos cinco minutos da micro-metáfora. As quatro últimas etapas comprimidas nos três minutos de clareza final, com narração firme, porque a pessoa volta ao mundo em seguida.
