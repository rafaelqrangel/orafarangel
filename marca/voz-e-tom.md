...
- **Proibida a dicotomia fatiada em qualquer pontuação** — "Não é X. É Y.", "não é X: é Y", "não é X; é Y" — **e o travessão de corte** ("O problema é outro — e tem saída."). Banimento definitivo decretado por Rafael em 22/08/2026: o contraste se liga por conjunção coordenativa ("mas", "porém", "e") dentro do mesmo período, nunca por corte de pontuação. O escritor humano liga o contraste por conjunção: "não é X, mas Y", "em vez de", "enquanto". O travessão parentético no meio da frase ("quem fica com o tempo — não com o dinheiro — se declara...") também é marca de IA; a informação entra por oração relativa ou reordenação da frase. (Feedback direto do Rafael, 26/07/2026.)
